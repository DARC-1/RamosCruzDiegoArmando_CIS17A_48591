 ...
 * Created on October 3, 2021, 12:23 PM
 */
...
int *mode(const int *array, int arySize) {
   ...
   // count identical elements while traversing
   // and keep track of max Frequency
   ...
   modeAry[0] = nmodes; //returns nomdes
   modeAry[1] = max_freq; //returns Frequency 1
   //Fill the mode array
   cur_element = -1; // current element
   cur_freq = 0; // current element frequenc
